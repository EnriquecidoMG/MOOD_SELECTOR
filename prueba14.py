...
from PyQt6.QtCore import Qt  # Asegúrate de importar Qt
...
class PresetWindow(QWidget):
    ...
    def init_ui(self):
        ...
        # Agregar un espacio entre los presets y el botón de opciones
    ...
    def load_presets(self):
        ...
        for preset_name in os.listdir("."):
            if preset_name.endswith(".json") and preset_name != CONFIG_FILE:
                # Quitar la extensión .json para el botón
