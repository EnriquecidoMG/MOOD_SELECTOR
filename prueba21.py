...
class PresetWindow(QWidget):
    ...
    def init_ui(self):
        ...
        background_label.setScaledContents(True)  # Asegurarse de que la imagen se ajuste al QLabel
        background_label.setGeometry(0, 0, 400, 500)  # Ajustar al tamaño de la ventana

        # Crear el layout principal
        layout = QVBoxLayout()
        layout.setContentsMargins(20, 20, 20, 20)  # Margen alrededor del layout
        ...
        self.setStyleSheet("""
            ...
            QPushButton {
                background-color: rgba(160, 160, 160, 0.8);  /* Gris más oscuro con transparencia */
                border: none;
            ...
            QPushButton:hover {
                background-color: rgba(176, 176, 176, 0.8);  /* Resaltado más claro */
            }
            #optionsButton {
                font-size: 15px;  /* Aumentar tamaño de fuente en un 25% */
                padding: 12px;  /* Aumentar espaciado interno en un 25% */
                min-width: 125px;  /* Ancho mínimo aumentado */
                max-width: 125px;  /* Ancho máximo aumentado */
            }
        """)
