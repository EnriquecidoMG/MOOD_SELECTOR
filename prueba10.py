...
from PyQt6.QtWidgets import (
    QApplication, QWidget, QVBoxLayout, QPushButton, QFileDialog, QListWidget, QLabel, QLineEdit, QMessageBox
)
...
class PresetWindow(QWidget):
    ...
    def init_ui(self):
        ...
        self.preset_list.itemDoubleClicked.connect(self.run_selected_preset)  # Conectar el doble clic
    ...
    def load_presets(self):
        ...
        self.preset_list.clear()  # Limpiar la lista antes de cargar
    ...
    def run_selected_preset(self, item):
    ...
    def show_options(self):
        ...
        self.hide()  # Oculta la ventana de presets
...
class DoomModSelectorApp(QWidget):
    ...
    def back_to_presets(self):
        ...
        self.close()  # Cierra la ventana de opciones
