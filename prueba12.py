...
from PyQt6.QtWidgets import (
    QApplication, QWidget, QVBoxLayout, QPushButton, QFileDialog, QGridLayout, QLabel, QLineEdit, QMessageBox, QListWidget
)
...
class DoomModSelectorApp(QWidget):
    ...
    def init_ui(self):
        ...
        self.list_widget = QListWidget()  # Asegúrate de que QListWidget está importado
